...
def hello():
    ...
    return render_template("coloumns.html",user1=form_data["name1"],user2=form_data["name2"],status=status,div_placeholder=Markup(status[5]),div_placeholder1=Markup(status[6]))
